...
png(
  filename = "../results/slingshot/Figure1_Slingshot_Trajectory_CellTypes.png",
  width = 3000,
  height = 2600,
  res = 300
)
...
for(i in seq_along(curves)){
  ...
  ggsave(
    paste0("../results/slingshot/Figure1", LETTERS[i],
...
for(i in seq_along(curves)){
  ...
  ggsave(
    paste0("../results/slingshot/Figure2", LETTERS[i],
...
for(i in 1:ncol(pt)) {
  ...
  ggsave(
    filename = paste0("../results/slingshot/Figure3_", lineage_name,
...
for(i in 1:3){
  ...
  write.csv(
    summary_i,
    paste0("../results/slingshot/Lineage", i, "_median_pseudotime_by_celltype.csv"),
    row.names = FALSE
  )
}
...
make_lineage_heatmap <- function(lineage_number, n_bins = 50) {
  ...
  ggsave(
    filename = paste0("../results/slingshot/Figure4_", lineage_name, "_UCell_Pseudotime_Heatmap.png"),
    plot = p,
    width = 9,
    height = 5.5,
    dpi = 300
  ...
  write.csv(
    df,
    file = paste0("../results/slingshot/Figure4_", lineage_name, "_UCell_Pseudotime_Heatmap_Data.csv"),
    row.names = FALSE
  )
}
...
for(score in ucell_cols){
  ...
  ggsave(
    filename = paste0("../results/slingshot/Figure5_", file_label, "_UCell_Slingshot_UMAP.png"),
    plot = p,
    width = 8.5,
    height = 6.5,
    dpi = 300
