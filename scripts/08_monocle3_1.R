...
ggsave(
  filename = "../results/monocle3_v2/monocle3_step3_refined_celltypes.png",
  plot = p,
  width = 10,
  height = 7,
  dpi = 300
...
ggsave(
  "../results/monocle3_v2/monocle3_trajectory_cell_type_refined.png",
  p1,
  width = 10,
  height = 8,
  dpi = 300
...
ggsave(
  "../results/monocle3_v2/monocle3_trajectory_condition_refined.png",
  p2,
  width = 10,
  height = 8,
  dpi = 300
...
# Save figure
ggsave(
  filename = "../results/monocle3_v2/monocle3_p1_pseudotime_final.png",
  plot = p_pseudotime,
  width = 7,
  height = 5,
  dpi = 300
...
# Save figure
ggsave(
  filename = "../results/monocle3_v2/monocle3_p2_pseudotime_final.png",
  plot = p_pseudotime,
  width = 7,
  height = 5,
  dpi = 300
...
# Save figure
ggsave(
  filename = "../results/monocle3_v2/monocle3_p3_pseudotime_final.png",
  plot = p_pseudotime,
  width = 7,
  height = 5,
  dpi = 300
