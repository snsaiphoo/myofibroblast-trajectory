# Run 08_momocle3.R first to establish environment for script
...
cds_p1 <- root_partition(
  cds_part = cds_p1,
  outdir = "../results/monocle3_v2/partition1",
  root_condition = "WT",
...
cds_p2 <- root_partition(
  cds_part = cds_p2,
  outdir = "../results/monocle3_v2/partition2",
...
cds_p3 <- root_partition(
  cds_part = cds_p3,
  outdir = "../results/monocle3_v2/partition3",
  root_condition = "WT",
