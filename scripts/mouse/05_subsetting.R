...
saveRDS(mesenchymal, file.path(data_dir, "mesenchymal_subset.rds"))
...
ggsave(
  file.path(fig_dir, "mesenchymal_umap_resolutions.png"),
  last_plot(),
...
ggsave(
  file.path(fig_dir, "mesenchymal_cluster_tree.png"),
  last_plot(),
  width = 18, height = 12, dpi = 300
)
...
ggsave(
  file.path(fig_dir, "mesenchymal_umap_res0.4.png"),
  last_plot(),
  width = 8, height = 6, dpi = 300
)

saveRDS(mesenchymal, file.path(data_dir, "mesenchymal_processed_res0.4.rds"))
...
write.csv(
  markers_mesenchymal,
  file.path(data_dir, "markers_mesenchymal_res0.4.csv"),
  row.names = FALSE
)

write.csv(
  top15_markers,
  file.path(data_dir, "top15_markers_mesenchymal_res0.4.csv"),
  row.names = FALSE
)

saveRDS(
  markers_mesenchymal,
  file.path(data_dir, "markers_mesenchymal_res0.4.rds")
)
...
ggsave(
  file.path(fig_dir, "mesenchymal_annotation_validation_dotplot.png"),
  last_plot(),
...
saveRDS(
  mesenchymal_clean,
  file.path(data_dir, "mesenchymal_refined_annotated.rds")
)