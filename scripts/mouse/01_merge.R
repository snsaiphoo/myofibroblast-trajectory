...
wt_clean   <- readRDS(file.path(data_dir, "wt_singlets.rds"))
i1d_clean  <- readRDS(file.path(data_dir, "i1d_singlets.rds"))
i7d_clean  <- readRDS(file.path(data_dir, "i7d_singlets.rds"))
i30d_clean <- readRDS(file.path(data_dir, "i30d_singlets.rds"))
...
saveRDS(
  combined,
  file.path(data_dir, "combined_singlets_counts_only.rds")
)
